...
function tracaImagem1(){
    ...
    imagemGrande.src = '/static/imagens/menu01.jpg'
}

function tracaImagem2(){
    var imagemGrande = document.getElementById('imagemCriancaGrande')

    imagemGrande.src = '/static/imagens/menu02.jpg'
}

function tracaImagem3(){
    var imagemGrande = document.getElementById('imagemCriancaGrande')

    imagemGrande.src = '/static/imagens/menu03.jpg'
}

function tracaImagem4(){
    var imagemGrande = document.getElementById('imagemCriancaGrande')

    imagemGrande.src = '/static/imagens/menu04.jpg'
}